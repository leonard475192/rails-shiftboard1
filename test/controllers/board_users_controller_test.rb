...
class BoardUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create board_user" do
    assert_difference('BoardUser.count') do
      post board_users_url, params: { board_user: { account_id: @board_user.account_id, display_name: @board_user.display_name, level: @board_user.level, store_id: @board_user.store_id } }
    end
  ...
  test "should update board_user" do
    patch board_user_url(@board_user), params: { board_user: { account_id: @board_user.account_id, display_name: @board_user.display_name, level: @board_user.level, store_id: @board_user.store_id } }
